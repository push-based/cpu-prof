...
} from './cli-coercion.js';

describe('CLI Coercion Utils', () => {
  describe('coerceStringArray', () => {
    ...
    it('should return undefined for undefined', () => {
      expect(coerceStringArray(undefined as unknown)).toBeUndefined();
    });
  ...
  describe('coerceNumberArray', () => {
    ...
    it('should return undefined for undefined', () => {
      expect(coerceNumberArray(undefined as unknown, 'PID')).toBeUndefined();
    });
