...
export function cpuProfileToTraceProfileEvents(cpuProfile: CPUProfile, opt: {
    ...
    tid: number;
    sequence?: number;
}): [CpuProfilerStartProfilingEvent, ProfileEvent, ProfileChunkEvent, CpuProfilerStopProfilingEvent] {
...
export function getThreadNameTraceEvent(pid: number, tid: number, name: string = "CrRendererMain"): ThreadNameEvent {
    return {
        cat: '__metadata',
        name: 'thread_name',
        ph: 'M',
...
export function getProcessNameTraceEvent(pid: number, tid: number, name: string): ProcessNameEvent {
    return {
        cat: '__metadata',
        name: 'process_name',
        ph: 'M',
 ...
 **/
export function cpuProfilesToTraceFile(cpuProfileInfos: CpuProfileInfo[]): TraceFile {
        ...
        traceEvents: [
            ...
            ...cpuProfileInfos.flatMap((info) => {
                ...
                return [
                    ...
                    ...(sourceFilePath ? [getProcessNameTraceEvent(pid, tid, sourceFilePath)] : []),
